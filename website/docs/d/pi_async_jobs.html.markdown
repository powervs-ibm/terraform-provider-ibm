...
layout: "ibm"
page_title: "IBM: pi_async_jobs"
description: |-
  Lists all asynchronous jobs in the Power Virtual Server cloud.
---

# ibm_pi_async_jobs

Retrieve information about all Power Systems Virtual Server asynchronous jobs for a cloud instance. For more information, about Power Virtual Server, see [getting started with IBM Power Systems Virtual Servers](https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-getting-started).

## Example Usage

```terraform
data "ibm_pi_async_jobs" "ds_async_jobs" {
...
- `async_jobs` - (List) List of asynchronous jobs.

  Nested scheme for `async_jobs`:
