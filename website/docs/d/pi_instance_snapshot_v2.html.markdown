...
description: |-
  Retrieves a single instance snapshot (v2) in the Power Virtual Server cloud.
---

# ibm_pi_instance_snapshot_v2

Retrieve information about a Power Systems Virtual Server instance snapshot (v2). For more information, about Power Virtual Server instance snapshots, see [getting started with IBM Power Systems Virtual Servers](https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-getting-started).

## Example Usage

```terraform
data "ibm_pi_instance_snapshot_v2" "ds_snapshot_v2" {
