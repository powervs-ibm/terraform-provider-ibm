...
- `pi_storage_pool` - (Optional, String) Storage Pool for server deployment; if provided then `pi_affinity_policy` will be ignored.
...
- `pi_storage_type` - (Required, String) - Storage type for server deployment. 
