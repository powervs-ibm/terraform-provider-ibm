...
- `pi_sys_type` - (Optional, String) The type of system on which to create the VM. The following values are supported on off-prem locations: s922/e980/s1022/e1080/Power11. The following values are supported on on-prem locations: s922/e980/s1022/e1080/s1122/e1150/e1180.
  - The following values are supported on SAP system types e980/s1022/e1050/e1080/Power11.
