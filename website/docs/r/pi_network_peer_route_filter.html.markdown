...
- `id` - (String) The unique identifier of the network peer route filter resource. Composed of `<pi_cloud_instance_id>/<pi_network_peer_id>/<oute_filter_id>`
- `route_filter_id` - (String) The unique identifier of the pi_network_peer_route_filter.
