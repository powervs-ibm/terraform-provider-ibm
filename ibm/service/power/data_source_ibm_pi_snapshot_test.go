		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_pi_snapshot.snapshot_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_pi_snapshot.snapshot_instance", "name"),
				),
			},
		},
	})
...
func testAccCheckIBMPISnapshotDataSourceConfigBasic() string {
	return fmt.Sprintf(`
		data "ibm_pi_snapshot" "snapshot_instance" {
